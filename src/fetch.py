        ...
        with Condition((address_wire[0] == last_read[0]) & ~self.rob_reset[0]):
            ...
            with Condition(lsbSeries):
                ...
                with Condition(inst.id == Bits(32)(24)):  # lw
                    ...
                    lsb.p_rs1.push(inst.rs1)
                    lsb.p_rs2.push(Bits(32)(0))
                    lsb.p_imm.push(inst.imm)
                    lsb.p_fetchid.push(tick[0])
                with Condition(inst.id == Bits(32)(27)):  # sw
                    lsb.p_opid.push(inst.id)
                    lsb.p_rs1.push(inst.rs1)
                    lsb.p_rs2.push(inst.rs2)
                    lsb.p_imm.push(inst.imm)
                    lsb.p_fetchid.push(tick[0])
